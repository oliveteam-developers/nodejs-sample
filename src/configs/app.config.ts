...
import joiErrorHandler from '@app/core/middlewares/joi-error-handler.middleware';
import { notFoundErrorHandler, errorHandler } from '@app/core/middlewares/api-error-handler.middleware';
...
// Router
app.use(constants.APPLICATION.url.basePath, Router);
